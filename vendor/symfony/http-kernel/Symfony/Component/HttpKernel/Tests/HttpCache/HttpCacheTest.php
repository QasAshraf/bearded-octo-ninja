...
class HttpCacheTest extends HttpCacheTestCase
{
    ...
    public function testServesFromCacheWhenHeadersMatch()
    {
        ...
        $this->request('GET', '/', array('HTTP_ACCEPT' => 'text/html', 'HTTP_USER_AGENT' => 'BON/1.0'));
        $this->assertEquals(200, $this->response->getStatusCode());
        $this->assertEquals('BON/1.0', $this->response->getContent());
        $this->assertTraceContains('miss');
        $this->assertTraceContains('store');
    ...
    public function testStoresMultipleResponsesWhenHeadersDiffer()
    {
        ...
        $this->request('GET', '/', array('HTTP_ACCEPT' => 'text/html', 'HTTP_USER_AGENT' => 'BON/2.0'));
        $this->assertEquals(200, $this->response->getStatusCode());
        $this->assertTraceContains('miss');
        $this->assertTraceContains('store');
        $this->assertEquals('BON/2.0', $this->response->getContent());
        ...
        $this->request('GET', '/', array('HTTP_USER_AGENT' => 'BON/2.0'));
        $this->assertTraceContains('miss');
        $this->assertEquals('BON/2.0', $this->response->getContent());
